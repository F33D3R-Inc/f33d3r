...
/// Transfer AET for a subscription or PPV payment.
/// Uses Ain Soph's /v1/transfer — platform takes 3% as fee.
...
/// Send a tip via Ain Soph's /v1/tip — 1% platform fee.
pub async fn tip(
    client: &Client,
    ain_soph_url: &str,
    from_pial: &str,
...
/// Returns the user's Verity KYC tier (0–3). Returns 0 on error (non-blocking).
