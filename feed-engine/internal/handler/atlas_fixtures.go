...
var atlasFixtures = map[string][]AtlasVariant{
	...
	"post_avatar": {
		{Label: "with realm ring + online", Data: map[string]any{
			"Handle": "mia", "AvatarURL": "", "AuthorName": "Mia 🎀", "Realm": 4, "IsOnline": true,
		}},
		{Label: "offline, no realm", Data: map[string]any{
			"Handle": "guest", "AvatarURL": "", "AuthorName": "Guest", "Realm": 1, "IsOnline": false,
		}},
	},
	"avatar_img": {
	...
	"user_avatar": {
		{Label: "creator, realm 4, online", Data: map[string]any{
			"Handle": "mia", "AvatarURL": "", "DisplayName": "Mia 🎀", "Realm": 4, "Size": "lg", "IsOnline": true,
		}},
	},
	...
	"btn_follow": {
		{Label: "not following", Data: map[string]any{"TargetPIAL": "demo", "TargetHandle": "mia", "IsFollowing": false}},
		{Label: "following", Data: map[string]any{"TargetPIAL": "demo", "TargetHandle": "mia", "IsFollowing": true}},
	},
	"btn_share": {
