...
func (p *Producer) client_(ctx context.Context) (*kgo.Client, bool) {
	...
	client, err := kgo.NewClient(
		...
		// acks=all: kgo enables idempotent producing by default and refuses to
		// build a client with weaker acks. These carry moderation and ranking
		// events, so durability beats throughput.
