...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', clearDmBadge);
  ...
  document.body.addEventListener('click', function (e) {
    ...
    if (e.target.closest('[data-gn-new]')) {
      var startInput = document.querySelector('.gn-new-input');
  ...
  document.body.addEventListener('click', function (e) {
    ...
    if (row) {
      var input = document.querySelector('.gn-new-input');
    ...
    // Click outside the search input/dropdown closes it.
    if (!e.target.closest('.gn-new-input-wrap')) gnHideDropdown();
  });
  ...
  document.addEventListener('keydown', function (e) {
    ...
    if (!document.activeElement || !document.activeElement.classList.contains('gn-new-input')) return;
