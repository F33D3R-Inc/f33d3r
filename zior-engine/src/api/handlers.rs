...
pub async fn upload_track(
        ...
        .map_err(|_| StatusCode::BAD_REQUEST)?
    {
        ...
        match name.as_str() {
            ...
            "track_id" => {
                // The caller's key for this audio. feed-engine sends its own
                // work id or track id so the signal is addressable by it;
                // a blank field is the same as no field.
                provided_id = field
                    .text()
                    .await
                    .ok()
    ...
    let topic_vector: [f32; 8] = mapped.psych_vector.0;
    {
